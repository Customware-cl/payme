...
sequenceDiagram
    ...
    Note over U,BE: ✅ FASE 2.1: Confirmación del Contacto (IMPLEMENTADO)
    ...
    alt Contacto confirma
        ...
        C->>B: [❌ No, rechazar]
        B-->>BE: Actualizar status='rejected'
        B->>C: Entendido, el préstamo ha sido rechazado.<br/>¿Puedes decirnos el motivo?<br/>1️⃣ No recibí el dinero/objeto<br/>2️⃣ El monto es incorrecto<br/>3️⃣ No conozco a esta persona
        B->>U: ❌ {contacto} rechazó el préstamo de $45.900<br/>Se ha cancelado el recordatorio
    end
...
| 2.1 | Confirmación del borrower (contacto) | ✅ Implementado |
